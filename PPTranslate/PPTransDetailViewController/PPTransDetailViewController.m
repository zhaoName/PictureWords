...
- (LTPTextView *)tv
{
    if (!_tv) {
        ...
        self.closeBtn.frame = CGRectMake(SCREEN_WIDTH - 70, 45, 30, 30);
    }
    return _tv;
}
...
{
    if (!_fanView) {
        _fanView = [[PPTransDetailView alloc] initWithFrame:CGRectMake(0, iSIPhoneX?88:64, SCREEN_WIDTH, SCREEN_HEIGHT - (iSIPhoneX?88:64)) model:self.model];
    }
    return _fanView;
}
