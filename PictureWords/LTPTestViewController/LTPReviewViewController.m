...
- (void)ltp_setupTextContent
{
    ...
    self.imageview.image = [UIImage imageNamed:model.keywordImageName];
...
- (UIView *)resultView
{
    if (_resultView == nil) {
        ...
        [closeButton setImage:[UIImage imageNamed:@"guanbi"] forState:UIControlStateSelected];
        [closeButton setImage:[UIImage imageNamed:@"guanbi"] forState:UIControlStateHighlighted];
        [closeButton setImage:[UIImage imageNamed:@"guanbi"] forState:UIControlStateDisabled];
        w = h = 40;
