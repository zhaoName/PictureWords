...
- (void)viewDidLoad {
    ...
    [self.avaterBtn sd_setImageWithURL:[NSURL URLWithString:@"https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1568228801428&di=cc2ffca8fb13f2b882def21a7a594628&imgtype=0&src=http%3A%2F%2Fimg.qqzhi.com%2Fuploads%2F2018-12-09%2F104843548.jpg"] forState:UIControlStateNormal placeholderImage:[UIImage imageNamed:@"logo"]];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0 && indexPath.row == 0) {
        ...
        [self.navigationController pushViewController:[LTPSuggestViewController new] animated:YES];
    }
...
{
    NSURL *commentUrl = [NSURL URLWithString:@"itms-apps://itunes.apple.com/WebObjects/MZStore.woa/wa/viewContentsUserReviews?id=1450714157&pageNumber=0&sortOrdering=2&type=Purple+Software&mt=8"];
