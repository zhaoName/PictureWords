...
- (void)viewDidLoad {
    ...
    self.dataSources = [[LTPLearnWordModel mj_objectArrayWithFile:path][self.showIndex] mutableCopy];
    [self addRightItem];
...
- (void)addRightItem
{
    ...
    UIImage *ingImage = [[ZZMediator defaultZZMediator] cat_imageWithName:@"collecting" atClass:UIImage.class bundleName:@"ZZLearnWords"];
    UIImage *edImage = [[ZZMediator defaultZZMediator] cat_imageWithName:@"collected" atClass:UIImage.class bundleName:@"ZZLearnWords"];
    [self.rightItem setImage:ingImage forState:UIControlStateNormal];
    [self.rightItem setImage:edImage forState:UIControlStateSelected];
