...
- (void)viewWillLayoutSubviews
{
    ...
    UIImage *backImage = [[ZZMediator defaultZZMediator] cat_imageWithName:@"popover_background" atClass:UIImage.class bundleName:@"ZZLearnWords"];
    CGImageRef cgImage = CGImageCreateWithImageInRect(backImage.CGImage, CGRectMake(0, 0, backImage.size.width + 35, backImage.size.height));
    backImage  = [UIImage imageWithCGImage:cgImage];
    CGImageRelease(cgImage);
    
    backImage = [backImage stretchableImageWithLeftCapWidth:5 topCapHeight:20];
//    backImage = [backImage resizableImageWithCapInsets:UIEdgeInsetsMake(20, 10, 10, 5) resizingMode:UIImageResizingModeStretch];
    self.arrowImageView = [[UIImageView alloc] initWithImage:backImage];
