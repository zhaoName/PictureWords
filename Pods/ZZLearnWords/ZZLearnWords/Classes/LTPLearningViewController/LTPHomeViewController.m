...
- (void)viewDidLoad {
    ...
    // table_header.jpg
    UIImage *bgImage = [[ZZMediator defaultZZMediator] cat_imageWithName:@"table_header.jpg" atClass:UIImage.class bundleName:@"ZZLearnWords"];
...
{
    UIImage *listImage = [[ZZMediator defaultZZMediator] cat_imageWithName:@"progress_list" atClass:UIImage.class bundleName:@"ZZLearnWords"];
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithImage:listImage style:UIBarButtonItemStylePlain target:self action:@selector(ltp_touchRightBarButtonItem)];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        ...
        cell = [[NSBundle bundleWithPath:path] loadNibNamed:@"LTPHomeTableViewCell" owner:nil options:nil].lastObject;
    }
...
- (UIPresentationController *)presentationControllerForPresentedViewController:(UIViewController *)presented presentingViewController:(UIViewController *)presenting sourceViewController:(UIViewController *)source
{
    ...
    cto.cusFrame = [UIView ltp_isIPhoneX] ? CGRectMake([UIView ltp_screenWidth] - 130, 70, 120, 120) : CGRectMake([UIView ltp_screenWidth] - 130, 50, 120, 120);
    return cto;
}
