...
- (void)viewWillLayoutSubviews
{
    ...
    UIImage *jiaImage = [[ZZMediator defaultZZMediator] cat_imageWithName:@"popover_background" atClass:UIImage.class bundleName:@"ZZLearnWords"];
    self.arrowImageView = [[UIImageView alloc] initWithImage:jiaImage];
