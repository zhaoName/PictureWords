...
- (void)viewDidLoad {
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:@"ImproveCollectionViewCell" bundle:[NSBundle bundleWithPath:path]] forCellWithReuseIdentifier:@"ImproveCollectionViewCell"];
}
...
{
    UIImage *jiaImage = [[ZZMediator defaultZZMediator] cat_imageWithName:@"review_nocanjia" atClass:UIImage.class bundleName:@"ZZLearnWords"];
    UIImageView *imageV = [[UIImageView alloc] initWithImage:jiaImage];
