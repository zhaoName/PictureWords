...
- (void)showCardView:(DataModel *)model
{
    ...
    self.echImageV.image = [[ZZMediator defaultZZMediator] cat_imageWithName:[NSString stringWithFormat:@"%@.png", model.keywordImageName] atClass:UIImage.class bundleName:@"ZZLearnWords"];
}
