...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    PPListenTableViewCell *cell = [[[NSBundle bundleForClass:self.class] loadNibNamed:@"PPListenTableViewCell" owner:self options:nil] lastObject];
...
- (PLTPPlayListenView *)playingControlView
{
    ...
    {
        _playingControlView = [[PLTPPlayListenView alloc] initWithFrame:CGRectMake(0, [UIView ltp_screenHeight] - 60 - ([UIView ltp_isIPhoneX]?34:0), [UIView ltp_screenWidth], 60)];
