...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section ==0) {
        PPTranslateTableViewCell *cell = [[[NSBundle bundleForClass:self.class] loadNibNamed:@"PPTranslateTableViewCell" owner:self options:nil] lastObject];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    UIView *conView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, [UIView ltp_screenWidth], 40)];
    ...
    moreBtn.frame = CGRectMake([UIView ltp_screenWidth] - 70, 10, 50, 30);
...
+ (void)ltp_saveTipsToDocumentPath
{
    ...
    //NSString *file = [ pathForResource:@"PPTips" ofType:];
