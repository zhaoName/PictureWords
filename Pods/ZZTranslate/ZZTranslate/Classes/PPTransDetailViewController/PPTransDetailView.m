...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        PPTransDetailTableViewCell *cell = [[[NSBundle bundleForClass:self.class] loadNibNamed:@"PPTransDetailTableViewCell" owner:self options:nil] lastObject];
...
{
    UIView * clearView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, [UIView ltp_screenWidth], 10)];
