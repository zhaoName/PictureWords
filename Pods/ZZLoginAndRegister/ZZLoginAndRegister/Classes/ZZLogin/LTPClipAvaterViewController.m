...
#define LOGIN_SCREEN_WIDTH [UIScreen mainScreen].bounds.size.width
...
- (void)viewDidLoad {
    ...
    self.avatorView = [[ZZMediator defaultZZMediator] cat_initClipView:CGRectMake(0, 80, LOGIN_SCREEN_WIDTH, 400) type:0 image:self.needClipImage midLineColor:lineColor];
